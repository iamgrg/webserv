...
Location::	Location(std::string _path, 
	...
	: _path(_path), _methods(_methods), _filesPath(_filesPath), _autoindex(_autoindex), _redirectPath(_redirectPath){ }
...
std::ostream &operator<<(std::ostream &os, const Location &location) {
    ...
    os << "   " << GREENLIGHT << " - " << "Methods: " << RESET;
    for (std::vector<std::string>::const_iterator it = location._methods.begin(); it != location._methods.end(); ++it) {
        os << *it << " ";
    }
    os << std::endl;
    os << "   " << GREENLIGHT << " - " << "Files Path: " << RESET;
    for (std::vector<std::string>::const_iterator it = location._filesPath.begin(); it != location._filesPath.end(); ++it) {
        os << *it << " ";
    }
    os << std::endl;
    os << "   " << GREENLIGHT << " - " << "Autoindex: " << RESET << (location._autoindex ? "On" : "Off") << std::endl;
    os << "   " << GREENLIGHT << " - " << "Redirect Path: " << RESET << location._redirectPath << std::endl;
    return os;
}
